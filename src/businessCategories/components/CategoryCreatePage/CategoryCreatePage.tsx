...
import { CategoryCreate_categoryCreate_errors } from "../../types/CategoryCreate";
        ...
        <Container>
          ...
          <PageHeader
            title={intl.formatMessage({
              defaultMessage: "Create New Business Category",
          ...
          <div>
            ...
            <SeoForm
              helperText={intl.formatMessage({
                defaultMessage:
                  "Add search engine title and description to make this business category easier to find"
              })}
              title={data.seoTitle}
