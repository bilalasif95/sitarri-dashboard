...
export const ProductList: React.FC<ProductListProps> = ({ params }) => {
  ...
  const [openModal, closeModal] = createDialogActionHandlers<
    ProductListUrlDialog,
    ProductListUrlQueryParams
  >(navigate, notificationsListUrl, params);
  ...
  const [
    ...
    cleanupFn: reset,
    createUrl: notificationsListUrl,
    getFilterQueryParam,
    navigate,
    params
  });
                    ...
                    {(productBulkPublish, productBulkPublishOpts) => (
                      <>
                        ...
                        >
                          <DialogContentText>
                            <FormattedMessage
                              defaultMessage="{counter,plural,one{Are you sure you want to delete this notification?} other{Are you sure you want to delete {displayQuantity} notifications?}}"
