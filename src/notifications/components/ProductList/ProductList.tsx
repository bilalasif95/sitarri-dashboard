        ...
        >
          ...
          >
            <span className={classes.colNameHeader}>
              <FormattedMessage defaultMessage="Type" description="notification type" />
            </span>
          </TableCellHeader>
          <DisplayColumn column="productType" displayColumns={settings.columns}>
            <TableCellHeader
          ...
          <DisplayColumn column="isPublished" displayColumns={settings.columns}>
            ...
            >
              <FormattedMessage
                ...
                description="notification business"
              />
            </TableCellHeader>
          </DisplayColumn>
            ...
            () => (
              <TableRow>
                <TableCell colSpan={numberOfColumns}>
                  <FormattedMessage defaultMessage="No notifications found" />
                </TableCell>
              </TableRow>
            )
          )}
