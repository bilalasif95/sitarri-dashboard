...
export interface ProductImageCreate_productImageCreate {
  __typename: "StoreImageDelete";
  storeErrors: ProductImageCreate_productImageCreate_errors[];
  store: ProductImageCreate_productImageCreate_product | null;
}

export interface ProductImageDelete {
  storeImagecreate: ProductImageCreate_productImageCreate | null;
}
