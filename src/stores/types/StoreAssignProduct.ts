...
export interface CollectionAssignProduct_collectionAddProducts_collection {
  __typename: "Store";
  id: string;
  productss: CollectionAssignProduct_collectionAddProducts_collection_products | null;
}
...
export interface CollectionAssignProduct_collectionAddProducts {
  __typename: "StoreAddProducts";
  store: CollectionAssignProduct_collectionAddProducts_collection | null;
  storeErrors: CollectionAssignProduct_collectionAddProducts_errors[];
}

export interface CollectionAssignProduct {
  storeAddproducts: CollectionAssignProduct_collectionAddProducts | null;
}
