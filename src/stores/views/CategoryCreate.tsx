...
import { TypedProductUpdateMutation, TypedProductUpdateMutationWithoutLogo } from "../../businesses/mutations";
        ...
        {({ data, loading }) => (
          <TypedProductUpdateMutation onCompleted={handleSuccess}>
            {(businessUpdate, businessUpdateOpts) => (
              <TypedProductUpdateMutationWithoutLogo onCompleted={handleSuccess}>
                {(businessUpdateWithoutLogo, businessUpdateWithoutLogoOpts) => (
                  <CategoryCreatePage
                    saveButtonBarState={storeCreateResult.status}
                    errors={errors}
                    category={maybe(() => data.business)}
                    latlngError={latlngError}
                    disabled={storeCreateResult.loading || latLngLoading || loading || businessUpdateOpts.loading || businessUpdateWithoutLogoOpts.loading}
                    onBack={() =>
